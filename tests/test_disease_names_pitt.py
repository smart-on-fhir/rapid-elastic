...
class TestDiseaseNamesPitt(unittest.TestCase):
    ...
    def test(self):
        ...
        # duplicates = [item for item, count in Counter(site_raw).items() if count > 1]
        # print(duplicates)
...
Steinert Myotonic dystrophy (Congenital onset; Childhood onset; Juvenile onset)
